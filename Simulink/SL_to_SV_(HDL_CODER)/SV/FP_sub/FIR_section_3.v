// -------------------------------------------------------------
// 
// File Name: D:\WorkSpace\LabWorks\DSP_SIMULINK\SL_to_SV\Filter\SV\FP_sub\FIR_section_3.v
...
// -------------------------------------------------------------
// 
// Module: FIR_section_3
// Source Path: FP_sub/fp model/FIR_section_3
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module FIR_section_3
  ...
  b0_1_block1 u_b0_1 (.c(b0_1_out1)  // sfix12_En11
                      );
  ...
  multb0_1_block1 u_multb0_1 (.In2(b0_1_out1),  // sfix12_En11
                              .In1(Delay01_out1),  // sfix11_En3
                              .Out1(multb0_1_out1)  // sfix22_En14
                              );

  b2_1_block1 u_b2_1 (.c(b2_1_out1)  // sfix12_En11
                      );
  ...
  multb2_1_block1 u_multb2_1 (.In2(b2_1_out1),  // sfix12_En11
                              .In1(Delay21_out1),  // sfix11_En3
                              .Out1(multb2_1_out1)  // sfix21_En13
                              );

  sumb2_1_block1 u_sumb2_1 (.In2(multb0_1_out1),  // sfix22_En14
                            .In1(multb2_1_out1),  // sfix21_En13
                            .Out1(sumb2_1_out1)  // sfix22_En14
                            );

  b4_1_block1 u_b4_1 (.c(b4_1_out1)  // sfix12_En11
                      );
  ...
  multb4_1_block1 u_multb4_1 (.In2(b4_1_out1),  // sfix12_En11
                              .In1(Delay12_out1),  // sfix11_En3
                              .Out1(multb4_1_out1)  // sfix21_En13
                              );

  sumb4_1_block1 u_sumb4_1 (.In2(sumb2_1_out1),  // sfix22_En14
                            .In1(multb4_1_out1),  // sfix21_En13
                            .Out1(sumb4_1_out1)  // sfix22_En14
                            );

  b6_block1 u_b6 (.c(b6_out1)  // sfix12_En11
                  );
  ...
  b4_2_block1 u_b4_2 (.c(b4_2_out1)  // sfix12_En11
                      );
  ...
  b2_2_block1 u_b2_2 (.c(b2_2_out1)  // sfix12_En11
                      );
  ...
  b0_2_block1 u_b0_2 (.c(b0_2_out1)  // sfix12_En11
                      );
  ...
  multb6_block1 u_multb6 (.In2(b6_out1),  // sfix12_En11
                          .In1(Delay03_out1),  // sfix11_En3
                          .Out1(multb6_out1)  // sfix20_En12
                          );

  sumb6_1_block1 u_sumb6_1 (.In2(sumb4_1_out1),  // sfix22_En14
  ...
  multb4_2_block1 u_multb4_2 (.In2(b4_2_out1),  // sfix12_En11
                              .In1(Delay23_out1),  // sfix11_En3
                              .Out1(multb4_2_out1)  // sfix21_En13
                              );

  sumb8_1_block1 u_sumb8_1 (.In2(sumb6_1_out1),  // sfix22_En14
  ...
  multb2_2_block1 u_multb2_2 (.In2(b2_2_out1),  // sfix12_En11
                              .In1(Delay14_out1),  // sfix11_En3
                              .Out1(multb2_2_out1)  // sfix21_En13
                              );

  sumb10_1_block1 u_sumb10_1 (.In2(sumb8_1_out1),  // sfix22_En14
  ...
  multb0_2_block1 u_multb0_2 (.In2(b0_2_out1),  // sfix12_En11
                              .In1(Delay05_out1),  // sfix11_En3
                              .Out1(multb0_2_out1)  // sfix22_En14
                              );

  sumb12_1_block1 u_sumb12_1 (.In2(sumb10_1_out1),  // sfix22_En14
