// -------------------------------------------------------------
// 
// File Name: D:\WorkSpace\LabWorks\DSP_SIMULINK\SL_to_SV\Filter\SV\FP_sub\IIR_section_3.v
...
// -------------------------------------------------------------
// 
// Module: IIR_section_3
// Source Path: FP_sub/fp model/IIR_section_3
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module IIR_section_3
  ...
  a6_block1 u_a6 (.c(a6_out1)  // sfix15_En11
                  );

  a12_block1 u_a12 (.c(a12_out1)  // sfix15_En11
                    );

  multa12_block1 u_multa12 (.In2(a12_out1),  // sfix15_En11
  ...
  multa6_block1 u_multa6 (.In2(a6_out1),  // sfix15_En11
                          .In1(sumin_out1),  // sfix36_En27
                          .Out1(multa6_out1)  // sfix29_En18
                          );

  suma6_block1 u_suma6 (.In1(multa6_out1),  // sfix29_En18
  ...
  sumd_block1 u_sumd (.In1(In3),  // sfix33_En22
                      .In2(Delay31_out1),  // sfix28_En17
                      .Out1(sumd_out1)  // sfix34_En23
                      );

  sumq_block1 u_sumq (.In2(sumd_out1),  // sfix34_En23
                      .In1(In2),  // sfix42_En31
                      .Out1(sumq_out1)  // sfix39_En28
                      );

  sumin_block1 u_sumin (.In1(Delay0_out1),  // sfix22_En14
  ...
  a4_block1 u_a4 (.c(a4_out1)  // sfix15_En11
                  );

  multa4_block1 u_multa4 (.In2(a4_out1),  // sfix15_En11
                          .In1(sumin_out1),  // sfix36_En27
                          .Out1(multa4_out1)  // sfix44_En33
                          );

  a10_block1 u_a10 (.c(a10_out1)  // sfix15_En11
                    );

  multa10_block1 u_multa10 (.In2(a10_out1),  // sfix15_En11
                            .In1(sumin_out1),  // sfix36_En27
  ...
  suma4_block1 u_suma4 (.In1(multa4_out1),  // sfix44_En33
  ...
  a2_block1 u_a2 (.c(a2_out1)  // sfix15_En11
                  );

  multa2_block1 u_multa2 (.In2(a2_out1),  // sfix15_En11
                          .In1(sumin_out1),  // sfix36_En27
                          .Out1(multa2_out1)  // sfix39_En29
                          );

  a8_block1 u_a8 (.c(a8_out1)  // sfix15_En11
                  );

  multa8_block1 u_multa8 (.In2(a8_out1),  // sfix15_En11
                          .In1(sumin_out1),  // sfix36_En27
  ...
  suma2_block1 u_suma2 (.In2(multa2_out1),  // sfix39_En29
