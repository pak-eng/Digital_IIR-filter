...
create_constraint_mode -name CONSTRAINTS -sdc_files {../Source/Log_Syn_Res/filter_constraints.sdc}
create_constraint_mode -name CONSTRAINTS_OPT -sdc_files {../Source/Log_Syn_Res/filter_constraints_OPT.sdc}
...
-qx_tech_file /Cadence/Libs/X_FAB/XKIT/xt018/cadence/v5_0/QRC_assura/v5_0_2/XT018_1243/QRC-Min/qrcTechFile
...
-qx_tech_file /Cadence/Libs/X_FAB/XKIT/xt018/cadence/v5_0/QRC_assura/v5_0_2/XT018_1243/QRC-Typ/qrcTechFile
...
-qx_tech_file /Cadence/Libs/X_FAB/XKIT/xt018/cadence/v5_0/QRC_assura/v5_0_2/XT018_1243/QRC-Max/qrcTechFile
...
create_analysis_view -name MAXviewOPT \
-delay_corner {DELAYcornerSLOW} \
-constraint_mode {CONSTRAINTS_OPT}

create_analysis_view -name MINviewOPT \
-delay_corner {DELAYcornerFAST} \
-constraint_mode {CONSTRAINTS_OPT}
